...
func NewPeer(provider SessionProvider, metadata string) *Peer {
	return &Peer{
		provider: provider,
		metadata: metadata,
	}
...
func (p *Peer) Join(sid string, sdp webrtc.SessionDescription, metadata string) (*webrtc.SessionDescription, error) {
	if p.publisher != nil {
...
func (p *Peer) GetMetadata() string {
	return p.metadata
}
